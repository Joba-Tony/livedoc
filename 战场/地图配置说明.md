...
| 等级 | 地图等级 | 主要怪物 | 适用场景 |
|------|----------|----------|----------|
| 1 | 1 | Slime、Giant-Ant、Rabbit、Cat、Orc | 新手农场(arefarm/elvfarm) |
| 2 | 1 | Slime、Giant-Ant、Amphis | 低级练级区 |
| 3 | 3 | Orc、Zombie、Skeleton、Orc-Mage、Stone-Golem、Cyclops、Troll等 | 中级野外 |
| 4 | 2 | Giant-Ant、Amphis、Stone-Golem、Clay-Golem、Hellbound、Cyclops | 低中级区域 |
| 5 | 3 | Giant-Ant、Orc、Zombie、Skeleton、Scorpion、Stone-Golem、Clay-Golem | 中级区域 |
| 6 | 4 | Skeleton、Orc-Mage、Cyclops、Troll、Stone-Golem、Tentocle等 | huntzone3/4 |
| 7 | 4 | Orc、Orc-Mage、Amphis、Rudolph、Giant-Tree、Troll、Unicorn(稀有) | areuni/elvuni |
| 8 | 4 | Zombie、Skeleton、Stone-Golem、Clay-Golem、Hellbound、Cyclops | 中高级区域 |
| 9 | 5 | Zombie、Skeleton、Stone-Golem、Cyclops、Orge、Hellbound、Liche(稀有) | 高级区域(可狂暴) |
| 10 | 5 | Cyclops、Skeleton、Stone-Golem、Orge、Hellbound、Liche | 高级区域(可狂暴) |
| 11 | 4 | Giant-Ant、Orc、Zombie、Skeleton、Scorpion、Amphis、Clay-Golem | 中级区域 |
| 12 | 4 | Slime、Giant-Ant、Amphis、Skeleton、Zombie、Stone-Golem、Giant-Frog | 中级区域 |
| 13 | 5 | Zombie、Hellbound、Cyclops、Orge、Dark-Elf、Beholder(狂暴群怪) | 高级狂暴区 |
| 14 | 5 | Dark-Elf、Beholder、Liche、Orge、Gagoyle(狂暴) | 高级区域 |
| 15 | 4 | Dark-Elf、Beholder、Liche、Gagoyle(狂暴) | 高级区域 |
| 16 | 1 | Scorpion、Giant-Ant、Amphis、Rudolph、Skeleton、Zombie、Stone-Golem | 2ndmiddle/huntzone1-2 |
| 17 | 1 | Giant-Frog、Stone-Golem、Rabbit、Rudolph、DireBoar、Ice-Golem、Frost | 冰雪区域 |
| 18 | 4 | Tentocle、ClawTurtle、Nizie、Giant-Crayfish、Stalker、Giant-Frog | **水域地图** |
| 19 | 4 | ClawTurtle、Tigerworm、Gagoyle、Tentocle、Dark-Elf、Beholder | 高级水域 |
| 20 | 4 | Lich、Demon、WereWolf、Frost、Ettin、Orge等(50%狂暴) | **顶级练级区** |
| 21 | 4 | Unicorn(94%)、Wyvern、Fire-Wyvern、MasterMage-Orc、Hellclaw、Tigerworm、Abaddon | **特殊高级区** |
