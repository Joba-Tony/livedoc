...
**说明**: 
- 第一个参数为开关(0/1)
- 第二个参数为怪物等级(1-21)，不同等级生成不同怪物组合

**等级对应怪物表**:

| 等级 | 地图等级 | 主要怪物 | 适用场景 |
|------|----------|----------|----------|
| 1 | 1 | Slime(史莱姆)、Giant-Ant(巨蚁)、Rabbit(野兔)、Cat(野猫)、Orc(半兽人) | 新手农场(arefarm/elvfarm) |
| 2 | 1 | Slime(史莱姆)、Giant-Ant(巨蚁)、Amphis(双头蛇) | 低级练级区 |
| 3 | 3 | Orc(半兽人)、Zombie(僵尸)、Skeleton(骷髅战士)、Orc-Mage(魔法半兽人)、Stone-Golem(石巨人)、Cyclops(独眼巨人)、Troll(山洞巨人)等 | 中级野外 |
| 4 | 2 | Giant-Ant(巨蚁)、Amphis(双头蛇)、Stone-Golem(石巨人)、Clay-Golem(泥巨人)、Hellbound(地狱犬)、Cyclops(独眼巨人) | 低中级区域 |
| 5 | 3 | Giant-Ant(巨蚁)、Orc(半兽人)、Zombie(僵尸)、Skeleton(骷髅战士)、Scorpion(毒蝎)、Stone-Golem(石巨人)、Clay-Golem(泥巨人) | 中级区域 |
| 6 | 4 | Skeleton(骷髅战士)、Orc-Mage(魔法半兽人)、Cyclops(独眼巨人)、Troll(山洞巨人)、Stone-Golem(石巨人)、Tentocle(泰塔克)等 | huntzone3/4 |
| 7 | 4 | Orc(半兽人)、Orc-Mage(魔法半兽人)、Amphis(双头蛇)、Rudolph(驯鹿)、Giant-Tree(树妖)、Troll(山洞巨人)、Unicorn(独角兽/稀有) | areuni/elvuni |
| 8 | 4 | Zombie(僵尸)、Skeleton(骷髅战士)、Stone-Golem(石巨人)、Clay-Golem(泥巨人)、Hellbound(地狱犬)、Cyclops(独眼巨人) | 中高级区域 |
| 9 | 5 | Zombie(僵尸)、Skeleton(骷髅战士)、Stone-Golem(石巨人)、Cyclops(独眼巨人)、Orge(食人魔)、Hellbound(地狱犬)、Liche(苔怪/稀有) | 高级区域(可狂暴) |
| 10 | 5 | Cyclops(独眼巨人)、Skeleton(骷髅战士)、Stone-Golem(石巨人)、Orge(食人魔)、Hellbound(地狱犬)、Liche(苔怪) | 高级区域(可狂暴) |
| 11 | 4 | Giant-Ant(巨蚁)、Orc(半兽人)、Zombie(僵尸)、Skeleton(骷髅战士)、Scorpion(毒蝎)、Amphis(双头蛇)、Clay-Golem(泥巨人) | 中级区域 |
| 12 | 4 | Slime(史莱姆)、Giant-Ant(巨蚁)、Amphis(双头蛇)、Skeleton(骷髅战士)、Zombie(僵尸)、Stone-Golem(石巨人)、Giant-Frog(巨蛙) | 中级区域 |
| 13 | 5 | Zombie(僵尸)、Hellbound(地狱犬)、Cyclops(独眼巨人)、Orge(食人魔)、Dark-Elf(暗夜精灵)、Beholder(旁观者/狂暴群怪) | 高级狂暴区 |
| 14 | 5 | Dark-Elf(暗夜精灵)、Beholder(旁观者)、Liche(苔怪)、Orge(食人魔)、Gagoyle(石像鬼/狂暴) | 高级区域 |
| 15 | 4 | Dark-Elf(暗夜精灵)、Beholder(旁观者)、Liche(苔怪)、Gagoyle(石像鬼/狂暴) | 高级区域 |
| 16 | 1 | Scorpion(毒蝎)、Giant-Ant(巨蚁)、Amphis(双头蛇)、Rudolph(驯鹿)、Skeleton(骷髅战士)、Zombie(僵尸)、Stone-Golem(石巨人) | 2ndmiddle/huntzone1-2 |
| 17 | 1 | Giant-Frog(巨蛙)、Stone-Golem(石巨人)、Rabbit(野兔)、Rudolph(驯鹿)、DireBoar(红毛野猪)、Ice-Golem(冰巨人)、Frost(冰雪女妖) | 冰雪区域 |
| 18 | 4 | Tentocle(泰塔克)、ClawTurtle(利爪龟)、Nizie(鱼人战士)、Giant-Crayfish(巨型鱼人)、Stalker(史塔克)、Giant-Frog(巨蛙) | **水域地图** |
| 19 | 4 | ClawTurtle(利爪龟)、Tigerworm(虎纹虫)、Gagoyle(石像鬼)、Tentocle(泰塔克)、Dark-Elf(暗夜精灵)、Beholder(旁观者) | 高级水域 |
| 20 | 4 | Liche(苔怪)、Demon(魔鬼)、WereWolf(狼人)、Frost(冰雪女妖)、Ettin(双头巨人)、Orge(食人魔)等(50%狂暴) | **顶级练级区** |
| 21 | 4 | Unicorn(独角兽/94%)、Wyvern(冰飞龙)、Fire-Wyvern(火龙)、MasterMage-Orc(半兽统领)、Hellclaw(地狱爪)、Tigerworm(虎纹虫)、Abaddon(阿巴丹) | **特殊高级区** |

**怪物名称中英对照表**:

| 英文名 | 中文名 | 英文名 | 中文名 |
|--------|--------|--------|--------|
| Slime | 史莱姆 | Skeleton | 骷髅战士 |
| Giant-Ant | 巨蚁 | Stone-Golem | 石巨人 |
| Rabbit | 野兔 | Clay-Golem | 泥巨人 |
| Cat | 野猫 | Cyclops | 独眼巨人 |
| Orc | 半兽人 | Troll | 山洞巨人 |
| Orc-Mage | 魔法半兽人 | Hellbound | 地狱犬 |
| Amphis | 双头蛇 | Orge | 食人魔 |
| Zombie | 僵尸 | Liche | 苔怪 |
| Scorpion | 毒蝎 | Demon | 魔鬼 |
| Giant-Frog | 巨蛙 | Unicorn | 独角兽 |
| Rudolph | 驯鹿 | WereWolf | 狼人 |
| DireBoar | 红毛野猪 | Dark-Elf | 暗夜精灵 |
| Ice-Golem | 冰巨人 | Beholder | 旁观者 |
| Frost | 冰雪女妖 | Gagoyle | 石像鬼 |
| Giant-Tree | 树妖 | Ettin | 双头巨人 |
| Tentocle | 泰塔克 | Stalker | 史塔克 |
| ClawTurtle | 利爪龟 | Hellclaw | 地狱爪 |
| Nizie | 鱼人战士 | Tigerworm | 虎纹虫 |
| Giant-Crayfish | 巨型鱼人 | Wyvern | 冰飞龙 |
| Fire-Wyvern | 火龙 | Abaddon | 阿巴丹 |
| MasterMage-Orc | 半兽统领 | Centaurus | 半人马 |


**特殊说明**:
- 等级9、10、13、14、15、20有概率生成**狂暴怪物**(bFirmBerserk)
- 等级13、14会生成**群怪**(iTotalMob=3-4只)
- 等级21有极小概率生成稀有怪物(Fire-Wyvern、Abaddon等)
- 地图等级(iMapLevel)影响怪物的基础属性和掉落
